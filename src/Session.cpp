...
SET_OPT(setHeader,              HEADER,        bool, long)
...
SET_OPT(setPathAsIs,            PATH_AS_IS,           bool        , long        )
#endif
SET_OPT(setProtocols,           PROTOCOLS,            long        , long        )
SET_OPT(setRedirProtocols,      REDIR_PROTOCOLS,      long        , long        )
SET_OPT(setProxy,               PROXY,                const char *, const char *)
SET_OPT(setProxyPort,           PROXYPORT,            long        , long        )
SET_OPT(setProxyType,           PROXYTYPE,            long        , long        )
SET_OPT(setNoProxy,             NOPROXY,              const char *, const char *)
SET_OPT(setHttpProxyTunnel,     HTTPPROXYTUNNEL,      bool        , long        )
SET_OPT(setSocks5GssApiService, SOCKS5_GSSAPI_SERVICE,const char *, const char *)
SET_OPT(setSocks5GssApiNec,     SOCKS5_GSSAPI_NEC,    bool        , long        )
SET_OPT(setInterface,           INTERFACE,            const char *, const char *)
...
SET_OPT(setPort,                PORT,                 long        , long        )
...
SET_OPT(setTlsAuthUsername,     TLSAUTH_USERNAME, const char *, const char *)
SET_OPT(setTlsAuthPassword,     TLSAUTH_PASSWORD, const char *, const char *)
SET_OPT(setTlsAuthType,         TLSAUTH_TYPE    , long        , long        )
...
SET_OPT(setTimeoutMs,            TIMEOUT_MS,           long        , long               )
...
SET_OPT(setConnectTimeoutMs,     CONNECTTIMEOUT_MS,    long        , long               )
SET_OPT(setIpResolve,            IPRESOLVE,            long        , long               )
SET_OPT(setConnectOnly,          CONNECT_ONLY,         bool        , long               )
SET_OPT(setUseSsl,               USE_SSL,              long        , long               )
...
SET_OPT(setAcceptTimeoutMs,      ACCEPTTIMEOUT_MS,     long        , long               )
...
SET_OPT(setSslKey,                            SSLKEY             , const char *, const char *)
SET_OPT(setSslKeyType,                        SSLKEYTYPE         , const char *, const char *)
...
SET_OPT(setSslIssuerCertificate,              ISSUERCERT         , const char *, const char *)
SET_OPT(setCaPath,                            CAPATH             , const char *, const char *)
SET_OPT(setCertificateRevocationListFile,     CRLFILE            , const char *, const char *)
...
SET_OPT(setEgdSocket,                         EGDSOCKET          , const char *, const char *)
...
SET_OPT(setKerberosLevel,                     KRBLEVEL           , const char *, const char *) // [FTP]

// Other options
SET_OPT(setPrivate,           PRIVATE            , void *, void *)
